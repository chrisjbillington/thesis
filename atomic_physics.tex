...
[TODO: rename $H_\up{fs}$ or $H_\up{D\,fs}$ or something]
...
\begin{align}
H_{\up{Z}\,\mathcal{I}\times\mathcal{J}} & = -\vec\mu_{\mathcal{I}\times\mathcal{J}}\cdot \vec B,
\end{align}
where
\begin{align}
\vec\mu_{\mathcal{I}\times\mathcal{J}} &=
