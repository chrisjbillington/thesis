...
% Move margin notes upward to prevent them running off the edge of the page:
% \usepackage{marginfix}
% Fixed margin footnotes not appearing at all sometimes. Conflicts with
% marginfix, but this is the better result for now:
\strictpagecheck
