...
Another method of spatial discretisation is the finite element discrete variable representation (\textsc{FEDVR}) [CITE]. As the name suggests, it is a finite element method, with a set of basis functions in each element, and each element linked at their boundaries.
