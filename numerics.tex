...
[talk about local parallelisability]


\tableref{table:rk4ilip_methods} summarises the capabilities of the methods considered in the following results section. There are two situations in which \textsc{rk4ilip} is the
