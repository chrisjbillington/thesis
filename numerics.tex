...
\ket{\psi(t + \upDelta t)} = e^{-\frac i \hbar \int_t^{t+ \upDelta t} \hat H(t^\prime)\,\dd t^\prime}\ket{\psi(t)}.
\end{align}
...
\begin{align}
\ket{\psi(t + \upDelta t)} = e^{-\frac {i \upDelta t} \hbar \hat H}\ket{\psi(t)}.
\end{align}
...
\begin{align}
\psi(t + \upDelta t) = U(t, t + \upDelta t)\psi(t),
\end{align}
where
\begin{align}
U(t, t + \upDelta t) = e^{-\frac {i \upDelta t} \hbar H}
\end{align}
is the unitary evolution operator for time evolution from the initial time $t$ to time $t + \upDelta t$, and is computed using a matrix exponential of $-\frac {i \upDelta t} \hbar H$. Exponentiation of matrices is defined via the Taylor series of the exponential,
\begin{align}
...
with
\begin{align}
U(t, t + \upDelta t) = e^{-\frac i \hbar \int_t^{t+ \upDelta t} H(t^\prime)\,\dd t^\prime}.
\end{align}
...
U(t, t + \upDelta t) = \mathcal{T}\left\{e^{-\frac i \hbar \int_t^{t+ \upDelta t} H(t^\prime)\,\dd t^\prime}\right\}.
\end{align}
...
\begin{align}
U(t, t + \upDelta t) &= \mathcal{T}\left\{\sum_{n=0}^\infty \frac1 {n!}\left[ -\frac i \hbar \int_t^{t+ \upDelta t} H(t^\prime)\,\dd t^\prime\right]^n\right\}\\
&= \sum_{n=0}^\infty \frac{(-i)^n} {n!\hbar^n}\mathcal{T}\left\{\int_t^{t+ \upDelta t} H(t^\prime)\,\dd t^\prime\right\}^n\,.
\end{align}
