...
\end{align}
With this final approximation, there are no longer any Guassian wavepackets to compute integrals over or anything else---all details of the wavepackets have been encapsulated and parametrised by the approximations and analytics in the preceding sections, and we can now focus on the classical dynamics of them atoms' centre of mass motion and the quantum evolution of their internal states.
...
The Markovian hidden-variable semiclassical method 

\subsubsection{Initial conditions}

\subsection{Mean auxiliary trajectories hidden-variables semiclassical method}
