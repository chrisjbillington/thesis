...
We now have an approximate analytic expression that is not computationally expensive to evaluate for each atom in an ensemble at every timestep of a differential equation.
