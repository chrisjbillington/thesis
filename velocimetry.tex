...
\end{align}
where $\phi_\up{K}(\vec r, t)$ is the complex phase of the potassium condensate wavefunction.

The rate of two body collisions is given by the scattering cross section and relative velocity as:
