...
\begin{table}
    ...
    \midrule
    cooling (standing wave) & $\ket{S_{1/2},2,2}\rightarrow \ket{P_{1/2},2,2}$ & + $66.6\,$MHz & $5.0\,$mW$\,$cm$^{-2}$ & $\pi$ \\
    \arrayrulecolor{black!30} \midrule
    cooling (standing wave) & $\ket{S_{1/2},1,1}\rightarrow \ket{P_{1/2},1,1}$ & + $31.9\,$MHz & $5.0\,$mW$\,$cm$^{-2}$ & $\pi$ \\
    \midrule
    ...
    \midrule
    repump (single beam) & $\ket{S_{1/2},1,0}\rightarrow \ket{P_\frac32,1,1}$  & $0$ & $10.0\,$mW$\,$cm$^{-2}$ & $\sigma^+$ \\
